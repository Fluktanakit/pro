                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="cal_id" class="form-control" placeholder="กรอกลำดับการดำเนินงาน">
                      </div>
                      <div class="form-group">
                        <label>การดำเนินงาน</label>
                        <input type="text" name="cal_name" class="form-control" placeholder="กรอกข้อมูลการดำเนินงาน">
                      </div>
                      <div class="form-group">
